class Alumno() {
    ...
    //Extensión del constructor por defecto.
    init {
        println("Extensión contructor por defecto. No responde a una extesión de constructor
 secundario ")
}
